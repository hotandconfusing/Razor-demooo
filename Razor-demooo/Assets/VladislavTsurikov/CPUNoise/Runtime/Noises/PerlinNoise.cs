...
namespace VladislavTsurikov.CPUNoise.Runtime
{
    public class PerlinNoiseCPU : NoiseCPU
    {
        ...
        public override float Sample2D(float x, float y)
        {
            ...
            float nx0 = Grad(Perm[ix0, iy0], fx0, fy0);
            float nx1 = Grad(Perm[ix0, iy0 + 1], fx0, fy1);
        ...
        public override float Sample3D(float x, float y, float z)
        {
            ...
            float nxy0 = Grad(Perm[ix0, iy0, iz0], fx0, fy0, fz0);
            float nxy1 = Grad(Perm[ix0, iy0, iz0 + 1], fx0, fy0, fz1);
