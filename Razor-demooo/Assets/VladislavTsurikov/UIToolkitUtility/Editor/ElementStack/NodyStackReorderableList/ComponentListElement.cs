...
namespace VladislavTsurikov.IMGUIUtility.Editor.ElementStack.UIToolkitReorderableList
{
    public class ComponentListElement : VisualElement
    {
        ...
        public ComponentListElement()
        {
            ...
            Toggle foldoutToggle = _foldout.Q<Toggle>();
            ...
            _activeToggle.RegisterValueChangedCallback(evt => { OnActiveChanged?.Invoke(this, evt.newValue); });
        ...
        public void SetComponent(Node component, bool showActiveToggle)
        {
            ...
            if (component != null)
            {
                ...
                _foldout.RegisterValueChangedCallback(evt => { component.SelectSettingsFoldout = evt.newValue; });
            }
        }
        ...
        public void StartRename()
        {
            ...
            _isRenaming = true;
            _renameField.value = Component.Name;
