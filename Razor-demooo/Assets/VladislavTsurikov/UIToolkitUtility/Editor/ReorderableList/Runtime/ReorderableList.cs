...
namespace VladislavTsurikov.UIToolkitReorderableList.Runtime
{
    public class ReorderableList : VisualElement
    {
        ...
        public ReorderableList()
        {
            ...
            _addButton = new Button(() => HandleAdd()) { text = "+" };
            ...
            _removeButton = new Button(() => HandleRemove()) { text = "-" };
        ...
        {
            ReorderableListElement listElement = new();

            if (MakeItem != null)
            {
                VisualElement customContent = MakeItem.Invoke();
