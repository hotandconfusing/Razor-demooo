...
namespace VladislavTsurikov.UIElementsUtility.Runtime
{
    public static class GetStyle
    {
        ...
        public static class SearchUtility
        {
            ...
            private static StyleGroup s_styleGroup;
            private static StyleSheet s_searchView;

            private static StyleGroup StyleGroup => s_styleGroup != null
                ? s_styleGroup
                : s_styleGroup = DataGroupUtility.GetGroup<StyleGroup, StyleInfo>("SearchUtility");

            public static StyleSheet SearchView =>
                s_searchView ? s_searchView : s_searchView = GetStyleSheet(StyleName.SearchView);
