...
namespace VladislavTsurikov.UIElementsUtility.Runtime
{
    public static class GetLayout
    {
        ...
        public static class SearchUtility
        {
            ...
            private static LayoutGroup s_layoutGroup;
            private static VisualTreeAsset s_searchView;

            private static LayoutGroup LayoutGroup => s_layoutGroup != null
                ? s_layoutGroup
                : s_layoutGroup = DataGroupUtility.GetGroup<LayoutGroup, LayoutInfo>("SearchUtility");

            public static VisualTreeAsset SearchView =>
                s_searchView ? s_searchView : s_searchView = GetVisualTreeAsset(LayoutName.SearchView);
