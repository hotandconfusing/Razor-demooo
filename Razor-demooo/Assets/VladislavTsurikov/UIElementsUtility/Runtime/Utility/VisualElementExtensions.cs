...
namespace VladislavTsurikov.UIElementsUtility.Runtime.Utility
{
    public static class VisualElementExtensions
    {
        ...
        {
            return target.HasParent() && target.style.display.value == DisplayStyle.Flex;
        }
        ...
        {
            return target.enabledSelf && target.enabledInHierarchy;
        }
        ...
        public static TO ReplaceWith<T, TO>(this T target, TO other) where T : VisualElement where TO : VisualElement
        {
            if (target.childCount > 0) //check if the target has children
            {
                ...
                List<VisualElement> children = new(target.Children());
            ...
            int targetIndexInParentHierarchy =
        ...
        {
            return target.focusable && target.focusController.focusedElement == target;
        }
        ...
        public static T AddPaddingSpace<T>(this T target, float left, float top, float right, float bottom)
            where T : VisualElement
        {
            return target.AddChild(new VisualElement()).SetName("PaddingSpace")
        ...
        {
            return target.AddChild(new VisualElement().SetName("Space").SetStyleSize(width, height));
        }

        public static T AddHorizontalSpace<T>(this T target, float height) where T : VisualElement
        {
            return target.AddChild(new VisualElement().SetName("HSpace").SetStyleHeight(height));
        }

        public static T AddVerticalSpace<T>(this T target, float width) where T : VisualElement
        {
            return target.AddChild(new VisualElement().SetName("VSpace").SetStyleWidth(width));
        }
        ...
        {
            return target.SetStyleMargins(0);
        }
        ...
        {
            return target.SetStyleDistance(0, 0, 0, 0);
        }
