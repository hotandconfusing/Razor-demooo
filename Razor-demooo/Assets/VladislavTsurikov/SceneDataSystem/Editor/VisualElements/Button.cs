...
namespace VladislavTsurikov.SceneDataSystem.Editor.VisualElements
{
    public class Button : VisualElement
    {
        ...
        {
            return SetElementSize(ElementSize.Normal);
        }
        ...
        {
            return SetLayoutOrientation(LayoutOrientation.Horizontal);
        }
        ...
        {
            return SetButtonStyle(ButtonStyle.Clear);
        }
    ...
    public static class ButtonExtensions
    {
        ...
        {
            return target.SetLabelText(string.Empty).SetTooltip(string.Empty);
        }
