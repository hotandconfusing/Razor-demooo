...
namespace VladislavTsurikov.SceneDataSystem.Editor
{
    ...
    public class SceneDataManagerWindow : BaseWindow<SceneDataManagerWindow>
    {
        ...
        private void InitializeListView()
        {
            ...
            List<VisualElement> listViewItems = new();
            ...
            for (int i = 0; i < _sceneDataManagerList.Count; i++)
            {
                ...
                EnumField enumField = new("Scene Type", sceneDataManager.SceneType);
                ...
                VisualElementListViewItem sceneManagerItem = new(raw, i, _listView)
                    { ItemRemoveButton = { OnClick = () => DeleteSceneDataManager(sceneDataManager) } };

                ListView sceneDatasListView = new();
                ...
                List<VisualElement> sceneDataElements = new();
                ...
                for (int j = 0; j < sceneDataManager.SceneDataStack.ElementList.Count; j++)
                {
                    ...
                    int index = j;
                    VisualElementListViewItem sceneDataItem = new(sceneDataLabel, index, _listView)
