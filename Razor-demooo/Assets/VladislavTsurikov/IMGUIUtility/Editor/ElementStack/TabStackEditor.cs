...
namespace VladislavTsurikov.IMGUIUtility.Editor.ElementStack
{
    public class TabStackEditor
    {
        ...
        public void OnGUI()
        {
            ...
            Rect tabRect = new(lineRect.x, lineRect.y, TabWidth, TabHeight);
            ...
            for (int tabIndex = 0; tabIndex < tabCount; tabIndex++)
            {
                ...
                if (tabRect.Contains(e.mousePosition))
                {
                    ...
                    if (Draggable)
                    {
                        ...
                        if (draggingTab != null)
                        {
                            SelectedWindowUtility.SetDragRect(e, tabRect, ref dragRect, out bool isAfter);
            ...
            switch (e.type)
            {
                ...
                case EventType.ContextClick:
                {
                    ...
                    if (tabUnderCursor != -1)
                    {
                        ...
                        if (!(tab as ISelectable).Selected)
                        {
                            Select(tabUnderCursor);
                        }
                        else
        ...
        private void Select(int index)
        {
            ...
            foreach (object localTab in _elements)
            {
