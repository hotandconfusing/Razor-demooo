...
namespace VladislavTsurikov.ColorUtility.Runtime
{
    public static class ColorExtensions
    {
        ...
        {
            return new Color(target.r, target.g, target.b, Mathf.Clamp01(value));
        }
        ...
        {
            return new Color(target.r + (other.r - target.r) * other.a,
        ...
        {
            return factorize ? Mathf.Round(target.ToHSL().h * HSL.H.F) : target.ToHSL().h;
        }
        ...
        {
            return factorize ? Mathf.Round(target.ToHSV().h * HSV.H.F) : target.ToHSV().h;
        }
