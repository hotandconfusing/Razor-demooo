...
namespace VladislavTsurikov.CustomInspector.Editor
{
    public static class CustomInspectorPreferencesProvider
    {
        ...
        {
            SettingsProvider provider = new("Preferences/CustomInspector", SettingsScope.User) {
                ...
                guiHandler = searchContext =>
                {
                    ...
                    settings.ShowFieldWithHideInInspectorAttribute = CustomEditorGUILayout.Toggle(
