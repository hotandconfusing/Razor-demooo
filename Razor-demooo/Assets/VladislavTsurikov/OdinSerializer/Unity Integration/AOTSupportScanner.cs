    ...
    public sealed class AOTSupportScanner : IDisposable
    {
            ...
            */
            ...
            try
            {
                ...
                ScriptableObject settings =
                    (ScriptableObject)AddressableAssetSettingsDefaultObject_Settings.GetValue(null, null);
            ...
            List<string> resourcesPaths = null)
        {
            ...
            try
            {
                ...
                HashSet<string> resourcesPathsSet = new();
                ...
                for (int i = 0; i < resourcePaths.Length; i++)
                {
                    ...
                    try
                    {
                        ...
                        string assetPath = resourcePaths[i];
                            ...
                            if ((go.hideFlags & HideFlags.DontSaveInBuild) == 0)
                            {
                                             ...
                                             .GetComponents<ISerializationCallbackReceiver>())
                                {
                                    try
                                    {
                                        ...
                                        ISupportsPrefabSerialization prefabSupporter =
                                            component as ISupportsPrefabSerialization;
