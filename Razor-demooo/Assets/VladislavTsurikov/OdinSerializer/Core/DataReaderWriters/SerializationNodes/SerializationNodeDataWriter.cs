    ...
    public class SerializationNodeDataWriter : BaseDataWriter
    {
        ...
        public override void BeginArrayNode(long length)
        {
            Nodes.Add(new SerializationNode {
                Name = string.Empty, Entry = EntryType.StartOfArray,
        ...
        {
            Nodes.Add(new SerializationNode {
                Name = name, Entry = EntryType.StartOfNode,
        ...
        {
            Nodes.Add(new SerializationNode {
                Name = name, Entry = EntryType.FloatingPoint, Data = value.ToString("G", CultureInfo.InvariantCulture)
            });
        }
        ...
        {
            Nodes.Add(new SerializationNode {
                Name = name, Entry = EntryType.FloatingPoint, Data = value.ToString("R", CultureInfo.InvariantCulture)
            });
        }
        ...
        {
            Nodes.Add(new SerializationNode {
                Name = name, Entry = EntryType.ExternalReferenceByGuid,
        ...
        {
            Nodes.Add(new SerializationNode {
                Name = name, Entry = EntryType.ExternalReferenceByIndex,
        ...
        {
            Nodes.Add(new SerializationNode {
                Name = name, Entry = EntryType.InternalReference, Data = id.ToString("D", CultureInfo.InvariantCulture)
            });
        }
        ...
        public override void WritePrimitiveArray<T>(T[] array)
        {
            ...
            {
                Nodes.Add(new SerializationNode {
                    Name = string.Empty, Entry = EntryType.PrimitiveArray,
