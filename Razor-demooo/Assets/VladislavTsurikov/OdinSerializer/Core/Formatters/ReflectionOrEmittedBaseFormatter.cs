...
namespace OdinSerializer
{
    public abstract class ReflectionOrEmittedBaseFormatter<T> : ReflectionFormatter<T>
    {
        ...
        {
            FormatterEmitter.RuntimeEmittedFormatter<T> formatter =
                FormatterEmitter.GetEmittedFormatter(typeof(T), reader.Context.Config.SerializationPolicy) as
            ...
            while ((entry =
                       reader.PeekEntry(out name)) != EntryType.EndOfNode && entry != EntryType.EndOfArray &&
        ...
        {
            FormatterEmitter.RuntimeEmittedFormatter<T> formatter =
                FormatterEmitter.GetEmittedFormatter(typeof(T), writer.Context.Config.SerializationPolicy) as
                    FormatterEmitter.RuntimeEmittedFormatter<T>;
