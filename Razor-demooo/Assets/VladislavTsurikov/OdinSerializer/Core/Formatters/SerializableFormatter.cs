    ...
    public sealed class SerializableFormatter<T> : BaseFormatter<T> where T : ISerializable
    {
        ...
        protected override void SerializeImplementation(ref T value, IDataWriter writer)
        {
            if (ISerializableConstructor != null)
            {
                ...
                SerializationInfo info = new(value.GetType(), writer.Context.FormatterConverter);
        ...
        private SerializationInfo ReadSerializationInfo(IDataReader reader)
        {
            ...
            if (entry == EntryType.StartOfArray)
            {
                try
                {
                    ...
                    SerializationInfo info = new(typeof(T), reader.Context.FormatterConverter);
        ...
        private SerializationInfo ReadSerializationInfo(IDataReader reader)
        {
            ...
            if (entry == EntryType.StartOfArray)
            {
                try
                {
                    ...
                    SerializationInfo info = new(SerializedType, reader.Context.FormatterConverter);
