...
namespace OdinSerializer
{
    ...
    public abstract class BaseFormatter<T> : IFormatter<T>
    {
        ...
        static BaseFormatter()
        {
            ...
            List<SerializationCallback> callbacks = new();
        ...
        private static SerializationCallback CreateCallback(MethodInfo info)
        {
            ...
            {
#if CAN_EMIT
                EmitUtilities.InstanceRefMethodCaller<T, StreamingContext> action =
                    EmitUtilities.CreateInstanceRefMethodCaller<T, StreamingContext>(info);
