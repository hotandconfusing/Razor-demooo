...
namespace OdinSerializer.Utilities
{
    ...
    public static class EmitUtilities
    {
        ...
        public static Func<FieldType> CreateStaticFieldGetter<FieldType>(FieldInfo fieldInfo)
        {
            ...
            {
                return () => { return (FieldType)fieldInfo.GetValue(null); };
            }

            string methodName = fieldInfo.ReflectedType.FullName + ".get_" + fieldInfo.Name;

            DynamicMethod getterMethod = new(methodName, typeof(FieldType), new Type[0], true);
        ...
        public static Func<object> CreateWeakStaticFieldGetter(FieldInfo fieldInfo)
        {
            ...
            if (EmitIsIllegalForMember(fieldInfo))
            {
                return () => { return fieldInfo.GetValue(null); };
            }

            string methodName = fieldInfo.ReflectedType.FullName + ".get_" + fieldInfo.Name;

            DynamicMethod getterMethod = new(methodName, typeof(object), new Type[0], true);
            ILGenerator gen = getterMethod.GetILGenerator();
        ...
        public static Action<FieldType> CreateStaticFieldSetter<FieldType>(FieldInfo fieldInfo)
        {
            ...
            DynamicMethod setterMethod = new(methodName, null, new[] { typeof(FieldType) }, true);
        ...
        public static Action<object> CreateWeakStaticFieldSetter(FieldInfo fieldInfo)
        {
            ...
            DynamicMethod setterMethod = new(methodName, null, new[] { typeof(object) }, true);
            ILGenerator gen = setterMethod.GetILGenerator();
            ...
            FieldInfo fieldInfo)
        {
            ...
            if (EmitIsIllegalForMember(fieldInfo))
            {
                return (ref InstanceType classInstance) => { return (FieldType)fieldInfo.GetValue(classInstance); };
            }

            string methodName = fieldInfo.ReflectedType.FullName + ".get_" + fieldInfo.Name;

            DynamicMethod getterMethod = new(methodName, typeof(FieldType),
                new Type[1] { typeof(InstanceType).MakeByRefType() }, true);
            ILGenerator gen = getterMethod.GetILGenerator();
            ...
            return (ValueGetter<InstanceType, FieldType>)getterMethod.CreateDelegate(
                typeof(ValueGetter<InstanceType, FieldType>));
#endif
        }
            ...
            FieldInfo fieldInfo)
        {
            ...
            if (EmitIsIllegalForMember(fieldInfo))
            {
                return (ref object classInstance) => { return (FieldType)fieldInfo.GetValue(classInstance); };
            }

            string methodName = fieldInfo.ReflectedType.FullName + ".get_" + fieldInfo.Name;

            DynamicMethod getterMethod = new(methodName, typeof(FieldType),
                new Type[1] { typeof(object).MakeByRefType() }, true);
            ILGenerator gen = getterMethod.GetILGenerator();
        ...
        public static WeakValueGetter CreateWeakInstanceFieldGetter(Type instanceType, FieldInfo fieldInfo)
        {
            ...
            if (EmitIsIllegalForMember(fieldInfo))
            {
                return (ref object classInstance) => { return fieldInfo.GetValue(classInstance); };
            }

            string methodName = fieldInfo.ReflectedType.FullName + ".get_" + fieldInfo.Name;

            DynamicMethod getterMethod = new(methodName, typeof(object), new Type[1] { typeof(object).MakeByRefType() },
                true);
            ILGenerator gen = getterMethod.GetILGenerator();
            ...
            FieldInfo fieldInfo)
        {
            ...
            DynamicMethod setterMethod = new(methodName, null,
                new Type[2] { typeof(InstanceType).MakeByRefType(), typeof(FieldType) }, true);
            ILGenerator gen = setterMethod.GetILGenerator();
            ...
            return (ValueSetter<InstanceType, FieldType>)setterMethod.CreateDelegate(
                typeof(ValueSetter<InstanceType, FieldType>));
#endif
        }
            ...
            FieldInfo fieldInfo)
        {
            ...
            if (EmitIsIllegalForMember(fieldInfo))
            {
                return (ref object classInstance, FieldType value) => { fieldInfo.SetValue(classInstance, value); };
            }

            string methodName = fieldInfo.ReflectedType.FullName + ".set_" + fieldInfo.Name;

            DynamicMethod setterMethod = new(methodName, null,
                new Type[2] { typeof(object).MakeByRefType(), typeof(FieldType) }, true);
            ILGenerator gen = setterMethod.GetILGenerator();
        ...
        public static WeakValueSetter CreateWeakInstanceFieldSetter(Type instanceType, FieldInfo fieldInfo)
        {
            ...
            if (EmitIsIllegalForMember(fieldInfo))
            {
                return (ref object classInstance, object value) => { fieldInfo.SetValue(classInstance, value); };
            }

            string methodName = fieldInfo.ReflectedType.FullName + ".set_" + fieldInfo.Name;

            DynamicMethod setterMethod = new(methodName, null,
                new Type[2] { typeof(object).MakeByRefType(), typeof(object) }, true);
            ILGenerator gen = setterMethod.GetILGenerator();
        ...
        public static WeakValueGetter CreateWeakInstancePropertyGetter(Type instanceType, PropertyInfo propertyInfo)
        {
            ...
            {
                return (ref object classInstance) => { return propertyInfo.GetValue(classInstance, null); };
            }
        ...
        public static Action<PropType> CreateStaticPropertySetter<PropType>(PropertyInfo propertyInfo)
        {
            ...
            if (EmitIsIllegalForMember(propertyInfo))
            {
                return value => { propertyInfo.SetValue(null, value, null); };
            }

            string methodName = propertyInfo.ReflectedType.FullName + ".set_" + propertyInfo.Name;

            DynamicMethod setterMethod = new(methodName, null, new[] { typeof(PropType) }, true);
            ILGenerator gen = setterMethod.GetILGenerator();
        ...
        public static Func<PropType> CreateStaticPropertyGetter<PropType>(PropertyInfo propertyInfo)
        {
            ...
            if (EmitIsIllegalForMember(propertyInfo))
            {
                return () => { return (PropType)propertyInfo.GetValue(null, null); };
            }

            string methodName = propertyInfo.ReflectedType.FullName + ".get_" + propertyInfo.Name;

            DynamicMethod getterMethod = new(methodName, typeof(PropType), new Type[0], true);
            ILGenerator gen = getterMethod.GetILGenerator();
            ...
            PropertyInfo propertyInfo)
        {
            ...
            DynamicMethod setterMethod = new(methodName, null,
                new Type[2] { typeof(InstanceType).MakeByRefType(), typeof(PropType) }, true);
            ILGenerator gen = setterMethod.GetILGenerator();
            ...
            return (ValueSetter<InstanceType, PropType>)setterMethod.CreateDelegate(
                typeof(ValueSetter<InstanceType, PropType>));
#endif
        }
            ...
            PropertyInfo propertyInfo)
        {
            ...
            DynamicMethod getterMethod = new(methodName, typeof(PropType),
                new[] { typeof(InstanceType).MakeByRefType() }, true);
            ILGenerator gen = getterMethod.GetILGenerator();
            ...
            return (ValueGetter<InstanceType, PropType>)getterMethod.CreateDelegate(
                typeof(ValueGetter<InstanceType, PropType>));
#endif
        }
        ...
        public static Action<object, TArg1> CreateWeakInstanceMethodCaller<TArg1>(MethodInfo methodInfo)
        {
            ...
            DynamicMethod method = new(methodName, null, new[] { typeof(object), typeof(TArg1) }, true);
        ...
        public static Action<object> CreateWeakInstanceMethodCaller(MethodInfo methodInfo)
        {
            ...
            if (EmitIsIllegalForMember(methodInfo))
            {
                return classInstance => { methodInfo.Invoke(classInstance, null); };
            }

            Type declaringType = methodInfo.DeclaringType;
            string methodName = methodInfo.ReflectedType.FullName + ".call_" + methodInfo.Name;

            DynamicMethod method = new(methodName, null, new[] { typeof(object) }, true);
            ILGenerator gen = method.GetILGenerator();
        ...
        public static Func<object, TArg1, TResult> CreateWeakInstanceMethodCaller<TResult, TArg1>(MethodInfo methodInfo)
        {
            ...
            DynamicMethod method = new(methodName, typeof(TResult), new[] { typeof(object), typeof(TArg1) }, true);
            ILGenerator gen = method.GetILGenerator();
        ...
        public static Func<object, TResult> CreateWeakInstanceMethodCallerFunc<TResult>(MethodInfo methodInfo)
        {
            ...
            DynamicMethod method = new(methodName, typeof(TResult), new[] { typeof(object) }, true);
            ILGenerator gen = method.GetILGenerator();
            ...
            MethodInfo methodInfo)
        {
            ...
            DynamicMethod method = new(methodName, typeof(TResult), new[] { typeof(object), typeof(TArg) }, true);
            ILGenerator gen = method.GetILGenerator();
            ...
            MethodInfo methodInfo)
        {
            ...
            DynamicMethod method = new(methodName, typeof(void), new[] { typeof(InstanceType).MakeByRefType() }, true);
            ILGenerator gen = method.GetILGenerator();
            ...
            return (InstanceRefMethodCaller<InstanceType>)method.CreateDelegate(
                typeof(InstanceRefMethodCaller<InstanceType>));
#endif
        }
            ...
            MethodInfo methodInfo)
        {
            ...
            DynamicMethod method = new(methodName, typeof(void),
                new[] { typeof(InstanceType).MakeByRefType(), typeof(Arg1) }, true);
            ILGenerator gen = method.GetILGenerator();
            ...
            return (InstanceRefMethodCaller<InstanceType, Arg1>)method.CreateDelegate(
                typeof(InstanceRefMethodCaller<InstanceType, Arg1>));
#endif
        }
    }
}
