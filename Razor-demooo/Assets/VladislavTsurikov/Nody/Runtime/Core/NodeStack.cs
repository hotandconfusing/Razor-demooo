...
namespace VladislavTsurikov.Nody.Runtime.Core
{
    ...
    public abstract class NodeStack<T> where T : Node
    {
        ...
        protected AllowedGroup AllowedGroup => _allowedGroup ??= new AllowedGroup();

        public ContextHierarchy ContextHierarchy => _contextHierarchy ??= new ContextHierarchy();
        ...
        public virtual bool AllowRemoveLastElement => true;
        ...
        {
            return _elementList.IndexOf(element);
        }
        ...
        {
            PortDefinitionContext context = new();
