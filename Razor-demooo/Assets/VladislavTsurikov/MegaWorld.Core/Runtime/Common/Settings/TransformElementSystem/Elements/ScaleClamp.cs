...
namespace VladislavTsurikov.MegaWorld.Runtime.Common.Settings.TransformElementSystem
{
    [Serializable]
    [Name("Scale Clamp")]
    [MegaWorldDocUrl("transform-components/scale-clamp")]
    public class ScaleClamp : TransformComponent
    {
        [HideInInspector]
        public float MaxScale = 2;

        [MinMaxSlider(0f, 5f, nameof(MaxScale), LabelPreset = MinMaxSliderLabelPreset.ScaleZeroToFive,
            LabelOverride = "Scale Clamp")]
