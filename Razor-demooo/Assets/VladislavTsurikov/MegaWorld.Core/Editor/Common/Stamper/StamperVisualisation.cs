...
namespace VladislavTsurikov.MegaWorld.Editor.Common.Stamper
{
    public class StamperVisualisation
    {
        ...
        public void Draw(BoxArea area, SelectionData data, float multiplyAlpha)
        {
            ...
            DrawPrototypeVisualisation(data, area, multiplyAlpha);
        }
            ...
            Type toolType = null)
        {
            ...
            if (data.SelectedData.HasOneSelectedGroup())
            {
                    ...
                    group.PrototypeType == typeof(PrototypeTerrainObject))
                {
                    ...
                    if (toolType != null)
                    {
                        filterSettings = (FilterSettings)group.GetElement(toolType, typeof(FilterSettings));
                    }

                    filterSettings ??= (FilterSettings)group.GetElement(typeof(FilterSettings));
        ...
        private void DrawPrototypeVisualisation(SelectionData data, BoxArea area, float multiplyAlpha)
        {
