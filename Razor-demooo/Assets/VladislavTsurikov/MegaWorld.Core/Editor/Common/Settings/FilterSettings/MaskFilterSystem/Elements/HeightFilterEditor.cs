...
namespace VladislavTsurikov.MegaWorld.Editor.Common.Settings.FilterSettings.MaskFilterSystem
{
    ...
    public class HeightFilterEditor : ReorderableListComponentEditor
    {
        ...
        public override void OnGUI(Rect rect, int index)
        {
            if (index != 0)
            {
                _heightFilter.BlendMode = (BlendMode)CustomEditorGUI.EnumPopup(
            ...
            _heightFilter.HeightFalloffType = (FalloffType)CustomEditorGUI.EnumPopup(
                new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight),
            ...
            {
                _heightFilter.HeightFalloffMinMax = CustomEditorGUI.Toggle(
                    new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight),
