        ...
        public void OnGUI(Shape shape)
        {
            ...
            if (ProceduralMaskFoldout)
            {
                ...
                if (ProceduralBrushPreviewTextureFoldout)
                {
                    ...
                    Rect finalRect = new(new Vector2(indentedRect.x, indentedRect.y), new Vector2(200, 200));

                    GUI.DrawTexture(finalRect, _target.GetMask(shape));
                ...
                {
                    _target.CreateProceduralTexture(shape);
                }
