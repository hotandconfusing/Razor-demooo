...
namespace VladislavTsurikov.MegaWorld.Editor.Core.MonoBehaviour
{
    public class MonoBehaviourToolEditor : EditorBase, IToolEditor
    {
        ...
        public virtual void DrawPrimaryToolButtons()
        {
        }
        ...
        private void DrawPrototypeSettings()
        {
            ...
            {
                CustomEditorGUILayout.HelpBox("Select one prototype to display prototype settings.", MessageType.Info);
            }
        }
        ...
        private void DrawGroupSettings()
        {
            ...
            {
                CustomEditorGUILayout.HelpBox("Select one group to display group settings", MessageType.Info);
            }
        }
