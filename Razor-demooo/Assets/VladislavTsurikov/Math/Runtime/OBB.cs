...
namespace VladislavTsurikov.Math.Runtime
{
    public struct OBB
    {
        ...
        public void Encapsulate(OBB otherOBB)
        {
            ...
            AABB modelAABB = new(Vector3.zero, Size);
        ...
        {
            return BoxMath.BoxIntersectsBox(Center, _size, Rotation, otherOBB.Center,
                otherOBB.Size, otherOBB.Rotation);
        }

        public bool ContainsPoint(Vector3 point)
        {
            return BoxMath.ContainsPoint(point, Center, _size, Rotation);
        }
